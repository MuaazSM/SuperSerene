...
export default function Home() {
  ...
  return (
    <div className="p-5 m-5 overflow-y-hidden">
      <title>Serene</title>
      <main className="min-h-screen flex flex-col items-center justify-center mt-[-120] overflow-y-hidden">
        <TextHoverEffect text="Serene" />
